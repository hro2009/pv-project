...
<!-- gauge js -->
<!--<script type="text/javascript" src="--><?//=base_url('assets/admin/') ?><!--/js/gauge/gauge.min.js"></script>-->
<!--<script type="text/javascript" src="--><?//=base_url('assets/admin/') ?><!--/js/gauge/gauge_demo.js"></script>-->
<!-- chart js -->
...
<!-- worldmap -->
<!--<script type="text/javascript" src="--><?//=base_url('assets/admin/') ?><!--/js/maps/jquery-jvectormap-2.0.1.min.js"></script>-->
<!--<script type="text/javascript" src="--><?//=base_url('assets/admin/') ?><!--/js/maps/gdp-data.js"></script>-->
<!--<script type="text/javascript" src="--><?//=base_url('assets/admin/') ?><!--/js/maps/jquery-jvectormap-world-mill-en.js"></script>-->

<!-- skycons -->
<script src="<?=base_url('assets/admin/') ?>/js/skycons/skycons.js"></script>
<script>
